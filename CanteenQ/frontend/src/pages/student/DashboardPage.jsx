...
import { ShoppingCart, AlertCircle, Sparkles, ArrowRight, History } from 'lucide-react';
    ...
    >
      <div className="container-custom">
        ...
        <div 
          ...
          className="mb-8 cursor-pointer rounded-[24px] border border-white/70 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-all hover:shadow-[0_24px_60px_rgba(15,23,42,0.15)] hover:-translate-y-1"
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="mb-2 inline-flex items-center gap-2 rounded-full bg-purple-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.28em] text-purple-700">
                <History size={14} />
                Your Orders
              </p>
              <h2 className="text-2xl font-bold text-slate-950">Track your orders</h2>
              <p className="mt-2 text-sm text-slate-600">View active orders, pickup times, and order history</p>
            </div>
            <div className="ml-4 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 p-4 shadow-lg">
